#!/usr/bin/env python3
"""Convert Food-101 (ethz/food101) to Lance with CLIP embeddings."""
...
HF_REPO_ID = "lance-format/food101-lance"
SOURCE_REPO = "ethz/food101"


def main() -> None:
    p = argparse.ArgumentParser(description="Food-101 -> Lance")
    p.add_argument("--out", default=str(REPO_ROOT.parent / "lance_cache" / "food101-lance"))
