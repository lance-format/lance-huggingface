#!/usr/bin/env python3
"""Convert CIFAR-10 (uoft-cs/cifar10) to Lance format with CLIP embeddings.

Image column key in the source is ``img`` (not ``image``).
"""
...
HF_REPO_ID = "lance-format/cifar10-lance"
SOURCE_REPO = "uoft-cs/cifar10"


def main() -> None:
    p = argparse.ArgumentParser(description="CIFAR-10 -> Lance")
    p.add_argument("--out", default=str(REPO_ROOT.parent / "lance_cache" / "cifar10-lance"))
