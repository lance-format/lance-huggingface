...
- lance
- clip-embeddings
pretty_name: imagenet-1k-val-lance
size_categories:
- 10K<n<100K
extra_gated_prompt: |-
  This dataset re-distributes the canonical ImageNet-1k validation split for
  research use only. By accessing it you agree to the original ImageNet
  [terms of access](https://image-net.org/download.php).
---
